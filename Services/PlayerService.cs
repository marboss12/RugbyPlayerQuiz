...
new Player {Name = "Де Ан Аккерман", Team = "Красный Яр", Position = "Центровой", ImageUrl = "akkerman.jpg"},
new Player {Name = "Никита Барышников", Team = "Красный Яр", Position = "Фланкер", ImageUrl = "baryshnikov.jpg"},
new Player {Name = "Александр Белослудцев", Team = "Красный Яр", Position = "Проп", ImageUrl = "belosludtsev.jpg"},
new Player {Name = "Азамат Битиев", Team = "Красный Яр", Position = "Замок", ImageUrl = "bitiev.jpg"},
new Player {Name = "Александр Будыченко", Team = "Красный Яр", Position = "Скрам-хав", ImageUrl = "budychenko.jpg"},
new Player {Name = "Никита Чурашов", Team = "Красный Яр", Position = "Столб", ImageUrl = "churashov.jpg"},
new Player {Name = "Карел Дю Пре", Team = "Красный Яр", Position = "Флай-хав", ImageUrl = "dupre.jpg"},
new Player {Name = "Евгений Елгин", Team = "Красный Яр", Position = "Винг", ImageUrl = "elgin.jpg"},
new Player {Name = "Франсуа Эстерхейзен", Team = "Красный Яр", Position = "Фулбэк", ImageUrl = "esterheisen.jpg"},
new Player {Name = "Максим Гаргалык", Team = "Красный Яр", Position = "Хукер", ImageUrl = "gargalyk.jpg"},
new Player {Name = "Рамиль Гайсин", Team = "Красный Яр", Position = "Центровой", ImageUrl = "gaysin.jpg"},
new Player {Name = "Дмитрий Герасимов", Team = "Красный Яр", Position = "Восьмой", ImageUrl = "gerasimov.jpg"},
new Player {Name = "Максим Кемаев", Team = "Красный Яр", Position = "Фланкер", ImageUrl = "kemaev.jpg"},
new Player {Name = "Виталий Климов", Team = "Красный Яр", Position = "Винг", ImageUrl = "klimov.jpg"},
new Player {Name = "Виктор Кононов", Team = "Красный Яр", Position = "Проп", ImageUrl = "kononov.jpg"},
new Player {Name = "Дмитрий Кротов", Team = "Красный Яр", Position = "Замок", ImageUrl = "krotov.jpg"},
new Player {Name = "Рашид Магомедсаидов", Team = "Красный Яр", Position = "Столб", ImageUrl = "magomed.jpg"},
new Player {Name = "Антон Макаренко", Team = "Красный Яр", Position = "Скрам-хав", ImageUrl = "makarenko.jpg"},
new Player {Name = "Евгений Малышкин", Team = "Красный Яр", Position = "Флай-хав", ImageUrl = "malyshkin.jpg"},
new Player {Name = "Тимур Маслов", Team = "Красный Яр", Position = "Фулбэк", ImageUrl = "maslov.jpg"},
new Player {Name = "Давит Месхи", Team = "Красный Яр", Position = "Центровой", ImageUrl = "meshi.jpg"},
new Player {Name = "Алексей Михальцов", Team = "Красный Яр", Position = "Хукер", ImageUrl = "mihaltsov.jpg"},
new Player {Name = "Виталий Немцев", Team = "Красный Яр", Position = "Фланкер", ImageUrl = "nemtsev.jpg"},
new Player {Name = "Данил Онищенко", Team = "Красный Яр", Position = "Винг", ImageUrl = "onischenko.jpg"},
new Player {Name = "Николас Оостхузен", Team = "Красный Яр", Position = "Восьмой", ImageUrl = "oosthoosen.jpg"},
new Player {Name = "Данил Орлик", Team = "Красный Яр", Position = "Проп", ImageUrl = "orlik.jpg"},
new Player {Name = "Мартинус Йоханнес Пельцер", Team = "Красный Яр", Position = "Замок", ImageUrl = "pelcer.jpg"},
new Player {Name = "Артем Ровский", Team = "Красный Яр", Position = "Столб", ImageUrl = "rovskiy.jpg"},
new Player {Name = "Ефим Рябищук", Team = "Красный Яр", Position = "Скрам-хав", ImageUrl = "ryabischuk.jpg"},
new Player {Name = "Алексей Щербань", Team = "Красный Яр", Position = "Флай-хав", ImageUrl = "scherban.jpg"},
new Player {Name = "Степан Серяков", Team = "Красный Яр", Position = "Фулбэк", ImageUrl = "seryakov.jpg"},
new Player {Name = "Данил Шумерин", Team = "Красный Яр", Position = "Центровой", ImageUrl = "shumerin.jpg"},
new Player {Name = "Денис Симпликевич", Team = "Красный Яр", Position = "Винг", ImageUrl = "simplikevich.jpg"},
new Player {Name = "Ульрих Стендер", Team = "Красный Яр", Position = "Хукер", ImageUrl = "stender.jpg"},
new Player {Name = "Андрей Темнов", Team = "Красный Яр", Position = "Фланкер", ImageUrl = "temnov.jpg"},
new Player {Name = "Владимир Тонкошкуров", Team = "Красный Яр", Position = "Восьмой", ImageUrl = "tonkoshkurov.jpg"},
new Player {Name = "Константин Узунов", Team = "Красный Яр", Position = "Проп", ImageUrl = "uzunov.jpg"},
new Player {Name = "Питер Якобс", Team = "Красный Яр", Position = "Замок", ImageUrl = "yakobs.jpg"},
    ...
    public List<Player> GetPlayers() => _players;
        ...
        public string GetPlayerStatus(int score)
        {
            var statuses = new Dictionary<int, List<string>>
            {
                ...
                [1] = new() { "Ужасный результат.", "Может, лучше в шахматы?" },
